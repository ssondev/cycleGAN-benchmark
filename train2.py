...
parser.add_argument('--decay_epoch', type=int, default=0, help='epoch to start linearly decaying the learning rate to 0')
...
def report_gpu_memory(unit='MB'):
    ...
    print(torch.cuda.memory_allocated()/devider, torch.cuda.memory_cached()/devider)
